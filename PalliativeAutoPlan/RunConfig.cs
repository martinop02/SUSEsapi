namespace PalliativeAutoPlan
{
    ...
    public static class RunConfig
    {
        ...
        /// <summary>
        /// The vertebra + OAR structures were already generated by an earlier run on this same image
        /// (e.g. a VMAT plan was made and the user now wants to try AP/PA too, without waiting for
        /// TotalSegmentator again). When set, the run reuses the structure set already open in the
        /// Eclipse context instead of creating a new one, skips segmentation and any fixation-gear
        /// handling, and aborts if a required structure is missing.
        ///
        /// A NEW plan is still created per prescription — named "MV{X} kopi {Y}" when a plan for
        /// that prescription already exists — reusing the existing CTV/PTV rather than rebuilding
        /// them. See <see cref="Segmenter.VerifyStructuresExist"/> and PlanFactory.ResolvePlanId.
        /// Off = the normal, full run.
        /// </summary>
