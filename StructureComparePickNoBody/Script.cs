...
using StructureComparePickNoBody;
...
{
    /// <summary>
    /// StructureComparePickNoBody — pick any two structure sets and compare them.
    ///
    ...
    public class Script
    {
        ...
        public void Execute(ScriptContext context)
        {
            ...
            if (patient == null)
            {
                MessageBox.Show("No patient is open.", "StructureComparePickNoBody",
            ...
            if (sets.Count < 2)
            {
                MessageBox.Show(
                    ...
                    "StructureComparePickNoBody", MessageBoxButton.OK, MessageBoxImage.Information);
                return;
            }
